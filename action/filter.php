...
if(isset($_POST['kresla'])){
  $catalog = $link->query("SELECT * FROM `catalog` WHERE `type` = 'кресла'");}

if(isset($_POST['divan'])){
  $catalog = $link->query("SELECT * FROM `catalog` WHERE `type` = 'диваны'");}

if(isset($_POST['posyda'])){
  $catalog = $link->query("SELECT * FROM `catalog` WHERE `type` = 'посуда'");}

if(isset($_POST['teksctil'])){
  $catalog = $link->query("SELECT * FROM `catalog` WHERE `type` = 'текстиль'");}

if(isset($_POST['shkaf'])){
  $catalog = $link->query("SELECT * FROM `catalog` WHERE `type` = 'шкафы'");}

if(isset($_POST['dekor'])){
  $catalog = $link->query("SELECT * FROM `catalog` WHERE `type` = 'декор'");}
